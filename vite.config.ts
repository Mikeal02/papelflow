...
const VENDOR_BUCKETS: Array<{ name: string; test: (id: string) => boolean }> = [
  ...
  {
    name: "vendor-query",
    test: (id) => /[\\/]node_modules[\\/]@tanstack[\\/]/.test(id),
  },
  {
  ...
  },
  {
    name: "vendor-pdf",
    test: (id) =>
      /[\\/]node_modules[\\/](jspdf|jspdf-autotable|canvg|html2canvas|dompurify)[\\/]/.test(
        id,
      ),
  },
  {
  ...
  },
  {
    name: "vendor-dates",
    test: (id) =>
      /[\\/]node_modules[\\/](date-fns|react-day-picker|@internationalized[\\/]date)[\\/]/.test(
        id,
      ),
  },
  {
    name: "vendor-radix",
    test: (id) => /[\\/]node_modules[\\/]@radix-ui[\\/]/.test(id),
  },
  {
    name: "vendor-aria",
    test: (id) =>
      /[\\/]node_modules[\\/](react-aria-components|@react-aria|@react-stately|@react-types)[\\/]/.test(
        id,
      ),
  },
  {
  ...
  {
    name: "vendor-icons-rc",
    test: (id) =>
      /[\\/]node_modules[\\/](react-icons|@radix-ui[\\/]react-icons)[\\/]/.test(
        id,
      ),
  },
  {
    ...
    test: (id) =>
      /[\\/]node_modules[\\/](embla-carousel[^/]*|vaul)[\\/]/.test(id),
  },
  {
    name: "vendor-cmdk",
    test: (id) => /[\\/]node_modules[\\/](cmdk|sonner|input-otp)[\\/]/.test(id),
  },
  {
    name: "vendor-storage",
    test: (id) => /[\\/]node_modules[\\/]idb[\\/]/.test(id),
  },
  {
    name: "vendor-utils",
    test: (id) =>
      /[\\/]node_modules[\\/](clsx|class-variance-authority|tailwind-merge|tailwindcss-animate|next-themes)[\\/]/.test(
        id,
      ),
  },
];
