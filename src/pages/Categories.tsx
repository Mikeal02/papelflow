            ...
            <div className="mt-2">
              ...
              <div className="h-1.5 rounded-full bg-muted/50 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(((spendingByCategory[cat.id] || 0) / Number(cat.budget_amount)) * 100, 100)}%`,
                  }}
                />
              </div>
            </div>
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {categories.length} categories • {expenseCategories.length}{" "}
              expense, {incomeCategories.length} income
            </p>
          </div>
          <Button
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={newCat.type}
                  onValueChange={(v: any) => setNewCat({ ...newCat, type: v })}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={newCat.group}
                  onValueChange={(v) => setNewCat({ ...newCat, group: v })}
                >
                  <SelectTrigger className="bg-muted/30">
