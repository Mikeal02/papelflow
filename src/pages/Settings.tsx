...
const Settings = () => {
  ...
  const handleCurrencyChange = async (newCurrency: string) => {
    await updateProfile.mutateAsync({ preferred_currency: newCurrency });
  };
  ...
  return (
    <>
            ...
            <div className="relative p-6 md:p-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-2 flex-wrap">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] font-medium border-border/40"
                    >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-6">
                {[
                  {
                    label: "Days Active",
                    value: String(dataStats.accountAge),
                    icon: Clock,
                    color: "text-primary",
                    bg: "bg-primary/8",
                  },
                  ...
                  {
                    label: "Savings Rate",
                    value: `${dataStats.savingsRate}%`,
                    icon: TrendingUp,
                    color:
                      dataStats.savingsRate >= 20
                        ? "text-income"
                        : "text-warning",
                    bg:
                      dataStats.savingsRate >= 20
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Automated weekly financial summaries with AI insights
              </p>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Get AI-powered spending insights every Monday
                </p>
              </div>
              <Switch
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast({
                      title: "📊 Summary sent!",
                      description: "Check your inbox for the weekly report.",
                    });
                  } catch {
                    toast({
                      title: "Could not send summary",
                      description: "Email delivery may not be configured yet.",
                      variant: "destructive",
                    });
                  } finally {
      ...
      />
      <SecurityCenterModal
        open={showSecurityCenter}
        onOpenChange={setShowSecurityCenter}
      />
    </>
  );
};
