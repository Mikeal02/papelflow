...
const Accounts = () => {
  ...
  const assets = filteredAccounts.filter(
  ...
  const renderAccountCard = (
    ...
    return (
      <motion.div
        ...
        className={cn(
          "stat-card group",
          section === "liability" && "border-expense/20",
        )}
      >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p
              className={cn(
                ...
                section === "liability" ? "text-expense" : "",
              )}
              title={formatCurrency(Math.abs(Number(account.balance)))}
            >
              {section === "liability" ? "-" : ""}
      ...
      <div className="space-y-5 md:space-y-6">
        ...
        <div className="stagger-kinetic grid gap-4 lg:grid-cols-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-bold text-income truncate">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-bold text-expense truncate">
            ...
            {liabilities.length > 0 && (
              <div>
                ...
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                  {liabilities.map((a, i) =>
                    renderAccountCard(a, i, "liability"),
                  )}
                </div>
              </div>
            )}
