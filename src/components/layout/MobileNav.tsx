        ...
        <div className="flex items-center justify-between h-full px-4">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="ml-1.5 text-[8px] font-bold text-primary tracking-widest uppercase">
                PRO
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[300px] bg-background/98 backdrop-blur-2xl border-border/20 p-0"
              >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        ...
        <div className="relative flex items-center justify-around px-2 pt-1.5 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
          ...
          <motion.button
            ...
            style={{
              boxShadow:
                "0 8px 24px -4px hsl(var(--primary) / 0.45), 0 2px 8px -2px hsl(var(--primary) / 0.25)",
            }}
          >
