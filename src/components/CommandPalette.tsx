...
const pages = [
  ...
  },
  {
    ...
    label: "Transactions",
    path: "/transactions",
    keywords: "payments spending",
  },
  {
    icon: Wallet,
    label: "Accounts",
    path: "/accounts",
    keywords: "bank credit wallet",
  },
  {
    icon: PieChart,
    label: "Budgets",
  ...
  },
  {
    ...
    label: "Analytics",
    path: "/analytics",
    keywords: "data insights intelligence",
  },
  {
    icon: BarChart3,
    label: "Reports",
    path: "/reports",
    keywords: "charts graphs export",
  },
  {
    icon: CalendarClock,
    label: "Subscriptions",
  ...
  },
  {
    ...
    label: "Recurring",
    path: "/recurring",
    keywords: "auto payments",
  },
  {
    icon: Sparkles,
    label: "Tax Estimator",
    path: "/tax",
    keywords: "taxes deductions",
  },
  {
    icon: Briefcase,
    label: "Investments",
    path: "/investments",
    keywords: "portfolio stocks",
  },
  {
    icon: Trophy,
    label: "Challenges",
    path: "/challenges",
    keywords: "gamification achievements",
  },
  {
    icon: Settings,
    label: "Settings",
    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Quick Actions">
          ...
          <CommandItem
            onSelect={() => runCommand(() => setActionCenterOpen(true))}
          >
