      ...
      <div className="relative flex items-center justify-between gap-2 mb-5">
        ...
        {topCategories.length > 0 && (
          <div className="text-right shrink-0">
            <p
              className="text-base sm:text-lg font-bold text-foreground truncate max-w-[120px]"
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        <span
                          className="font-bold text-xs sm:text-sm tabular-nums truncate max-w-[80px] sm:max-w-[100px]"
