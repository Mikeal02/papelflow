...
export function NetWorthMini() {
  ...
  const { trendData, currentNetWorth, change, changePercent } = useMemo(() => {
    ...
    const prevMonth =
      data.length >= 2 ? data[data.length - 2].cumulative : currentBalance;
            ...
            <motion.div
              ...
              animate={{
                boxShadow: [
                  ...
                  "0 0 20px 5px hsl(var(--accent) / 0.3)",
                  "0 0 0 0 hsl(var(--accent) / 0)",
                ],
              }}
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            <ShineEffect>
              <CountUpValue
                ...
                className="text-xl sm:text-2xl lg:text-3xl font-bold block truncate"
                duration={1800}
              />
            </ShineEffect>
