    ...
    >
      ...
      <div className="grid grid-cols-7 gap-[3px] mb-3">
        {days.slice(0, 28).map((day, i) => {
          const intensity =
            day.amount > 0 ? Math.max(0.15, day.amount / maxAmount) : 0;
            ...
            <div key={i} className="relative">
              <div
                className={cn(
                  ...
                  day.isToday &&
                    "ring-1.5 ring-primary ring-offset-1 ring-offset-background",
              ...
              <AnimatePresence>
                {isHovered && (day.isPast || day.isToday) && (
                  ...
                  >
                    ...
                    <p className="text-[10px] font-bold text-expense tabular-nums">
          ...
          {[
            ...
            <div key={l.label} className="flex items-center gap-1">
              <div
                ...
                style={{
                  backgroundColor: `hsl(var(--expense) / ${l.opacity})`,
                }}
              />
