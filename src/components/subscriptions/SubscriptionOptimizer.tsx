      ...
      const response = await supabase.functions.invoke("financial-advisor", {
        body: {
          messages: [
            {
              role: "user",
              content: `Analyze these subscriptions and give 3 specific cost-saving tips:\n${subList}`,
            },
          ],
          financialContext: {
            budgetStatus: `${subscriptions.length} active subscriptions, ${formatCurrency(totalPotentialSaving)}/mo potential savings`,
          },
        },
      });
