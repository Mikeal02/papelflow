                ...
                text: `Analyze this receipt image and extract the following information in JSON format:
{
  ...
  "total": numeric total amount (number, not string),
  "items": [
    { "name": "item description", "amount": numeric price }
  ],
  "category": "suggested category from: Food & Dining, Groceries, Shopping, Transportation, Entertainment, Healthcare, Utilities, Other",
  "confidence": "high", "medium", or "low" based on image clarity
}

If you cannot read certain fields, set them to null. Return ONLY valid JSON, no other text.`
              },
              {
                type: "image_url",
                image_url: {
